...
c Hossein
      ...
      subroutine gauss_2(aa,bb,xx,nglob,n,det,iflag)
!===========================================================
...
!===========================================================
      implicit none 
      integer n,nglob
      REAL*8 aa(nglob,nglob),bb(nglob),xx(nglob)
      REAL*8 a(n,n), b(n), x(n)
      REAL*8 s(n)
      REAL*8  c, pivot, store, det
      integer i,ii, j, k, l, iflag
      iflag=0
...
!     Check if the system has a sigular matrix
         if(pivot.EQ.0.0.OR.iflag.EQ.1) then
            iflag=1
...
c$$$      do i=1,n
c$$$c         write(*,*)'det',det
c$$$         if(log(abs(det)).GT.200*log(10.)) THEN
c$$$            write(*,*)'ERROR IN DETERMINANT'          
c$$$            do,ii=1,n
c$$$               x(ii)=0.
c$$$            enddo
c$$$            return
